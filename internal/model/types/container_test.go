...
func TestGetResourceRequirements(t *testing.T) {
	...
	tests := []struct {
		...
		{ // 1
			in: &Container{Labels: map[string]string{
				"testtender.io.request-cpu": "500m",
			}},
		...
		{ // 2
			in: &Container{Labels: map[string]string{
				"testtender.io.request-cpu": "500m,2000m",
			}},
		...
		{ // 3
			in: &Container{Labels: map[string]string{
				"testtender.io.request-cpu": ",2000m",
			}},
		...
		{ // 4
			in: &Container{Labels: map[string]string{
				"testtender.io.request-cpu": "joyrex",
			}},
			reqlim: map[string]string{},
			err:    true,
		},
		{ // 5
			in: &Container{Labels: map[string]string{
				"testtender.io.request-memory": "500Mi",
			}},
		...
		{ // 6
			in: &Container{Labels: map[string]string{
				"testtender.io.request-memory": "500Mi,2000Mi",
			}},
		...
		{ // 7
			in: &Container{Labels: map[string]string{
				"testtender.io.request-memory": ",2000Mi",
			}},
		...
		{ // 8
			in: &Container{Labels: map[string]string{
				"testtender.io.request-memory": "joyrex",
			}},
			reqlim: map[string]string{},
			err:    true,
		},
		{ // 9
			in: &Container{Labels: map[string]string{
				"testtender.io.request-memory": "500Mi,2000Mi,2500Mi",
			}},
			reqlim: map[string]string{},
			err:    true,
		},
		{ // 10
			in: &Container{Labels: map[string]string{
				"testtender.io.request-memory": "500Mi,joyrex",
			}},
			reqlim: map[string]string{},
			err:    true,
		},
		...
		{ // 12
			in: &Container{Labels: map[string]string{
				"testtender.io.request-cpu": ",1000000000n",
			}},
		...
		{ // 13
			in: &Container{Labels: map[string]string{
				"testtender.io.request-memory": "209715200",
			}},
		...
		{ // 16
			in: &Container{Labels: map[string]string{
				"testtender.io.request-ephemeral-storage": "209715200",
			}},
		...
		{ // 17
			in: &Container{Labels: map[string]string{
				"testtender.io.request-ephemeral-storage": "500Mi,2000Mi",
			}},
...
func TestGetNodeSelector(t *testing.T) {
	tests := []struct {
		...
		{ // 1
			in: &Container{Labels: map[string]string{
				"testtender.io.node-selector": "a=b",
			}},
			inNodeSel:  map[string]string{},
		...
		{ // 2
			in: &Container{Labels: map[string]string{
				"testtender.io.node-selector": "a=b,c=d",
			}},
			inNodeSel:  map[string]string{},
		...
		{ // 5
			in: &Container{Labels: map[string]string{
				"testtender.io.node-selector": "format-error",
			}},
			inNodeSel:  map[string]string{},
			outNodeSel: map[string]string{},
			err:        true,
...
func TestGetImagePullPolicy(t *testing.T) {
	tests := []struct {
		...
		{ // 1
			in: &Container{Labels: map[string]string{
				"testtender.io.pull-policy": "always",
			}},
		...
		{ // 2
			in: &Container{Labels: map[string]string{
				"testtender.io.pull-policy": "something",
			}},
			policy: corev1.PullIfNotPresent,
			err:    true,
		},
...
func TestGetServiceAccountName(t *testing.T) {
	tests := []struct {
		...
		{ // 1
			in: &Container{Labels: map[string]string{
				"testtender.io.service-account": "default",
			}},
			outsa: "default",
		},
		{ // 2
			in: &Container{Labels: map[string]string{
				"testtender.io.service-account": "jtkirk",
			}},
			outsa: "jtkirk",
		},
		{ // 3
...
func TestGetPodName(t *testing.T) {
	tests := []struct {
		...
		{ // 0
			...
			name: "testtender-1234",
		},
		{ // 1
			in: &Container{ShortID: "1234", Name: "", Labels: map[string]string{
				"testtender.io.name-prefix": "space",
			}},
			name: "space-1234",
		},
		{ // 2
			in: &Container{ShortID: "1234", Name: "", Labels: map[string]string{
				"testtender.io.name-prefix": "s.pace",
			}},
			name: "space-1234",
		},
		{ // 3
		...
		{ // 5
			in: &Container{ShortID: "1234", Name: "exploration_909", Labels: map[string]string{
				"testtender.io.name-prefix": "s_pace",
			}},
...
func TestGetRunasUser(t *testing.T) {
	tests := []struct {
		...
		{ // 3
			in: &Container{Labels: map[string]string{
				"testtender.io.runas-user": "9999999999999999999999999999999",
			}},
			outsc: corev1.PodSecurityContext{},
			err:   true,
		},
		...
		{ // 9
			in: &Container{Labels: map[string]string{
				"testtender.io.runas-user": "root:root",
			}},
			insc:  &corev1.PodSecurityContext{RunAsUser: makeIntPointer(500)},
			outsc: corev1.PodSecurityContext{RunAsUser: makeIntPointer(0)},
			err:   false,
...
func TestGetActiveDeadlineSeconds(t *testing.T) {
	tests := []struct {
		...
		{ // 2
			in: &Container{Labels: map[string]string{
				"testtender.io.active-deadline-seconds": "foo",
			}},
			deadline: nil,
			err:      true,
		},

...
func TestToKubernetesValue(t *testing.T) {
	tests := []struct {
		...
		{
			in:    "01234567890123456789012345678901234567890123456789012345678901.3456789",
			key:   "01234567890123456789012345678901234567890123456789012345678901",
			value: "01234567890123456789012345678901234567890123456789012345678901",
			name:  "01234567890123456789012345678901234567890123456789012345678901",
		},
		{
			in:    "StrategicMars-",
			key:   "StrategicMars",

...
func TestDeleteContainerInstanceID(t *testing.T) {
	tests := []struct {
		in  *types.Container
		kub *instance
		ins int
			...
			kub: &instance{
				...
				cli: fake.NewSimpleClientset(&corev1.Pod{
					ObjectMeta: metav1.ObjectMeta{
						Name:      "tb303",
						Namespace: "default",
						Labels:    map[string]string{"testtender.io/container-id": "tb303", "testtender.io/instance-id": "6502"},
					},
				}),
			},
			in:  &types.Container{ID: "rc752", ShortID: "tb303", Name: "f1spirit"},
			...
			kub: &instance{
				...
				cli: fake.NewSimpleClientset(&corev1.Pod{
					ObjectMeta: metav1.ObjectMeta{
						Name:      "tb303",
						Namespace: "default",
						Labels:    map[string]string{"testtender.io/container-id": "tb303", "testtender.io/instance-id": "z80"},
					},
				}),
			},
			in:  &types.Container{ID: "rc752", ShortID: "tb303", Name: "f1spirit"},
	...
	for i, tst := range tests {
		if err := tst.kub.DeleteWithInstanceID("z80"); err != nil {
...
func TestDeleteContainerTestTender(t *testing.T) {
	tests := []struct {
		in  *types.Container
		kub *instance
		all int
			...
			kub: &instance{
				...
				cli: fake.NewSimpleClientset(&corev1.Pod{
					ObjectMeta: metav1.ObjectMeta{
						Name:      "tb303",
						Namespace: "default",
						Labels:    map[string]string{"testtender.io/managed": "true", "testtender.io/instance-id": "6502"},
					},
				}),
			},
			in:  &types.Container{ID: "rc752", ShortID: "tb303", Name: "f1spirit"},
			...
			kub: &instance{
				...
				cli: fake.NewSimpleClientset(&corev1.Pod{
					ObjectMeta: metav1.ObjectMeta{
						Name:      "tb303",
						Namespace: "default",
						Labels:    map[string]string{"testtender.io/managed": "true", "testtender.io/instance-id": "z80"},
					},
				}),
			},
			in:  &types.Container{ID: "rc752", ShortID: "tb303", Name: "f1spirit"},
...
func TestDeleteServices(t *testing.T) {
	...
	for i, tst := range tests {
		if err := tst.kub.deleteServices("testtender.io/container-id=" + tst.id); err != nil {
			t.Errorf("failed test %d - unexpected error  %s", i, err)
		}
			...
			kub: &instance{
				...
				cli: fake.NewSimpleClientset(&corev1.Pod{
					ObjectMeta: metav1.ObjectMeta{
						Name:      "f1spirit",
						Namespace: "default",
						Labels:    map[string]string{"testtender.io/managed": "true"},
					},
				}),
			},
			cnt: 0,
	...
	kub := &instance{
		...
		cli: fake.NewSimpleClientset(&corev1.Pod{
			ObjectMeta: metav1.ObjectMeta{
				Name:      "f1spirit",
				Namespace: "default",
				Labels:    map[string]string{"testtender.io/container-id": "303"},
			},
		}),

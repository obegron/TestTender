package io.testtender.examples.testcontainers;
...
public class NginxTest {
    ...
    void testNginx() throws IOException {
        GenericContainer nginx = new GenericContainer(DockerImageName.parse(NGINX_IMAGE))
            ...
            //.withClasspathResourceMapping results into a copy in a running container (unless testtender runs with --pre-archive)
